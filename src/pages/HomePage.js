    ...
    <div className="homePageContainer">
      <div className="container">
        ...
        <div className="homePageContentContainer">
          ...
          <p>
            The Amazon River pink dolphin is a symbol of the rich biodiversity
            of the Amazon basin and plays a crucial role in the health of its
          ...
          <ul>
            <li>
              ...
              regions, they are also hunted for use as bait in catfish
              fisheries.
            </li>
            <li>
              <b>Conservation Efforts:</b> Various conservation efforts are in
              place to protect this species, including habitat protection,
              pollution control, and legal protection measures. Organizations
              are also working to raise awareness about the importance of
              conserving these unique animals.
            </li>
          </ul>
          ...
          <ul>
            <li>
              ...
              become pinker as they age. Their color can vary from a light pink
              to a deep pink, and it can change depending on their mood, water
            ...
            <li>
              <b>Body Structure:</b> They have a robust body with a large,
              rounded forehead, long beak, and flexible neck, which allows them
              to maneuver easily through the complex network of flooded forests,
              rivers, and lakes.
            </li>
          </ul>
          <br />
